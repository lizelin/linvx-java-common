 ...
 * 
 *         log4j.rootLogger=INFO,C log4j.logger.net.linvx=DEBUG,R
 * 
 *         log4j.appender.C=org.apache.log4j.ConsoleAppender
 *         log4j.appender.C.layout=org.apache.log4j.PatternLayout
 *         log4j.appender.C.layout.ConversionPattern=[%p] %-d{yy-MM-dd HH:mm:ss}
 *         [%c : %L] %m%n
 * 
 *         log4j.appender.R=org.apache.log4j.DailyRollingFileAppender
 *         log4j.appender.R.File=E:/techwks/eclipse/LinvxTools/logs/log4j-app.
 *         log log4j.appender.R.layout=org.apache.log4j.PatternLayout
 *         log4j.appender.R.layout.ConversionPattern=[%p] %-d{yy-MM-dd HH:mm:ss}
 *         [%c : %L] %m%n
 * 
 *         log4j.appender.WEB=org.apache.log4j.DailyRollingFileAppender
 *         log4j.appender.WEB.File=E:/techwks/eclipse/LinvxTools/logs/log4j-web.
 *         log log4j.appender.WEB.layout=org.apache.log4j.PatternLayout
